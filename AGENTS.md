# template-php-quickmux

Quickmux application template with explicit integration, MySQL migrations, and PSR implementations.

## Stack

- Language: PHP 8.5
- Runtime: GNU/Linux, extensions apcu, pdo_mysql
- Libraries: PSR interfaces
...
- User: devcontainer
- Sidecars: mysql (migrations target), valkey (cache)
- Up: `make up`
...
- `destroy` — tear down volumes and sidecars
